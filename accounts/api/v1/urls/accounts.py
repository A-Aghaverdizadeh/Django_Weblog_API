...
urlpatterns = [
    ...
    path('password-reset/', views.PaswordResetRequestView.as_view(), name='password-rest-request'),
    path('password-reset/confirm/<str:token>', views.PasswordResetAPIView.as_view(), name='password-rest'),
    # token
